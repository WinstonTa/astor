...
/**
 * Wraps children in an animated "metallic" border — four turbulent
 * feTurbulence noise layers displaced through feDisplacementMap, giving
 * a rippling electric/silver glow around the edge of the wrapped element.
 *
 * Ported from the classic react-bits "Electric Border" pattern.
 */
      ...
      [...dyAnims, ...dxAnims].forEach((a) => {
        ...
        if (typeof anim.beginElement === "function") {
          try {
            ...
            // Safari can throw if the animation hasn't attached yet — safe to ignore.
          }
        }
      });
    });
